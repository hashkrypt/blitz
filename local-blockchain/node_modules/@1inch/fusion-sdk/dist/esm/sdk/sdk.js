            ...
            value: function getActiveOrders() {
                ...
                return _async_to_generator(function() {
                    ...
                    return _ts_generator(this, function(_state) {
                        request = ActiveOrdersRequest.new({
                            page: page,
                            limit: limit
                        });
                        return [
        ...
        },
        {
            ...
            value: function getOrderStatus(orderHash) {
                ...
                return _async_to_generator(function() {
                    var request;
                    return _ts_generator(this, function(_state) {
                        request = OrderStatusRequest.new({
                            orderHash: orderHash
                        });
                        return [
                            2,
        ...
        },
        {
            ...
            value: function getOrdersByMaker(param) {
                ...
                return _async_to_generator(function() {
                    var request;
                    return _ts_generator(this, function(_state) {
                        request = OrdersByMakerRequest.new({
                            limit: limit,
                            page: page,
                            address: address
                        });
        ...
        },
        {
            ...
            value: function getQuoteWithCustomPreset(params, body) {
                ...
                return _async_to_generator(function() {
                    ...
                    return _ts_generator(this, function(_state) {
                        paramsRequest = QuoterRequest.new({
                            fromTokenAddress: params.fromTokenAddress,
                            toTokenAddress: params.toTokenAddress,
                            amount: params.amount,
                            walletAddress: params.walletAddress || Address.ZERO_ADDRESS.toString(),
                        ...
                        bodyRequest = QuoterCustomPresetRequest.new({
            ...
            value: function buildCancelOrderCallData(orderHash) {
                ...
                return _async_to_generator(function() {
                    ...
                    return _ts_generator(this, function(_state) {
                        switch(_state.label){
                            case 0:
                                getOrderRequest = OrderStatusRequest.new({
                                    orderHash: orderHash
                                });
                                return [
                                    4,
                            ...
                            case 1:
                                ...
                                return [
                                    2,
                                    encodeCancelOrder(orderHash, new MakerTraits(BigInt(order.makerTraits)))
                                ];
                        }
                    });
                })();
        ...
        },
        {
            ...
            value: function getQuoteResult(params) {
                ...
                return _async_to_generator(function() {
                    ...
                    return _ts_generator(this, function(_state) {
                        quoterRequest = QuoterRequest.new({
                            fromTokenAddress: params.fromTokenAddress,
                            toTokenAddress: params.toTokenAddress,
                            amount: params.amount,
                        ...
                        quoterWithCustomPresetBodyRequest = QuoterCustomPresetRequest.new({
